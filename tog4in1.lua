...
local user_opts = {
    ...
    scalefullscreen = 2.5,            	-- scaling of the controller when fullscreen (vidscale false 4K)
...
local osc_styles = {
	...
	ctrlLoop = '{\\blur0\\bord0\\1c&H'.. grey ..'&\\3c&H'.. grey ..'&\\fs11\\fnoscc}',
	togTooltip = '{\\blur0\\bord0\\1c&H'.. grey ..'&\\3c&H'.. grey ..'&\\fs16\\fnmpv-osd-symbols}',
    ...
    vidTitle = "{\\blur0\\bord0\\1c&H" ..white.. "&\\3c&H0\\fs15\\q2\\fn" .. user_opts.titlefont .. "}",
